...
class Sidebar extends React.Component {
  ...
  static defaultProps = {
    ...
    sidebarOpened: true,
    activeItem: "",
    usertype: localStorage.getItem("user_Type_set"),
  };
    ...
    return (
      ...
      >
        <nav className={s.root} style={{ overflowY: "scroll" }}>
          ...
          >
            <img
              src="https://www.mindlyf.com/static/media/mind-lyf-04.8babbb2a.png"
              alt="logo"
          ...
          <ul className={s.nav}>
            ...
            {/* ----------------------------------------------------------------- */}
            {/* staff menu */}
            {localStorage.getItem("user_Type_set") === "staff" ? (
              <>
                <LinksGroup
                  onActiveSidebarItemChange={(activeItem) =>
                    this.props.dispatch(changeActiveSidebarItem(activeItem))
            ...
            {/* -------------------------------------------------------------- */}
            {/* Docter Menu*/}
            {localStorage.getItem("user_Type_set") === "doctor" ? (
              <>
                <LinksGroup
                  onActiveSidebarItemChange={(activeItem) =>
                    this.props.dispatch(changeActiveSidebarItem(activeItem))
